...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT (*) FROM characters JOIN character_books ON characters.series_id = books.series_id JOIN character_books ON books.id = character_books.book_id"
end
