...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(*) FROM characters GROUP BY characters.species ORDER BY DESC LIMIT 1"
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT character_books.book_id FROM characters JOIN books ON characters.series_id = books.series_id JOIN character_books ON books.id = character_books.book_id"
end
